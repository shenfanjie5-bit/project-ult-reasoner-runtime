...
**所属模块**: `reasoner_runtime/structured/` (主要写入) + `reasoner_runtime/core/engine.py` (填充 call/parse 槽位) + `reasoner_runtime/providers/client.py` (补充 LiteLLM/Instructor 初始化) + `tests/test_structured.py`
